...
.container {
            ...
            margin: 50px auto;
            padding: 50px;
            background-image: url(homepage\ 1\ kertas\ .png);
            position: relative;
            z-index: 0;
        ...
        <div>
            <form action="">
                ...
                <select id="metode" name="metode">
                    ...
                    <option value="">Tertabrak</option>
                    <option value="">Keracunan</option>
                    <option value="">Bunuh Diri</option>
                    <option value="">Tertembak</option>
                    <option value="">Tertusuk</option>
                </select>
